...
I componenti contenitori invece sono incaricati di gestire la logica dell'applicazione e forniscono i dati e gli eventi ai componenti di presentazione. Questo approccio migliora la separazione delle occupazioni all'interno dell'interfaccia definendo i componenti contenitori come dei super-componenti (anche chiamati \textit{Higher-order components}) con uno stato interno ed un ruolo attivo nell'architettura dell'applicazione che si compongono attraverso i vari componenti di presentazione autonomi.
